...
//
//    public MyRateLimiter2(RedisTemplate<String, Object> redisTemplate, RedisScript<List<Long>> redisScript) {
...
//     * @return 是否放行
//     */
//    public RateLimiter.Response isAllowed(String key, LimiterConfig config) {
//
...
//            List<Long> results = this.redisTemplate.execute(this.redisScript, keys,
//                    scriptArgs);
//            if (CollectionUtils.isEmpty(results)) {
//                LimiterConfig.builder().burstCapacity(1)
//                        .requestedTokens(1).replenishRate(1).build();
//                new RateLimiter.Response(1L,
//                        getHeaders(config, 1L));
//            }
